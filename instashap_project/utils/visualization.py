...
def plot_metric_bars(metrics_df: pd.DataFrame, metric: str, output_path: str | Path, title: str) -> None:
    ...
    output_path = _ensure_parent(output_path)
    plt.figure(figsize=(8, 5))
    sns.barplot(data=metrics_df, x="model", y=metric, palette="crest")
    plt.title(title)
    plt.xlabel("")
...
def plot_feature_importance(
    ...
    plt.figure(figsize=(8, 5))
    sns.barplot(data=frame, x="importance", y="feature", palette="viridis")
    plt.title(title)
...
def plot_explanation_alignment(
    ...
    plt.figure(figsize=(8, 5))
    sns.barplot(data=frame, x="mae", y="feature", palette="magma")
    plt.title(title)
