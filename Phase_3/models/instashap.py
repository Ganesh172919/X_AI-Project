...
class InstaSHAPModel(GAMModel):
    """Masked additive model whose component outputs serve as SHAP attributions."""
    def __init__(self, preprocessor: TabularPreprocessor, output_dim: int, hidden_dims: list[int],
        ...
        super().__init__(preprocessor=preprocessor, output_dim=output_dim, hidden_dims=hidden_dims,
                         interactions=interactions, dropout=dropout)
